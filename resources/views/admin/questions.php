...
if(isset($_POST['filter']))
{
	...
	if($_REQUEST['review_topic_id'] != "")
	{
		$sess_where .= " and question_cat_id = '".$_REQUEST['review_topic_id']."'";
		$_SESSION['review_topic_id_session'] = $_REQUEST['review_topic_id'];
	}
	else
	{
		unset($_SESSION['review_topic_id_session']);
	}
...
if(isset($_POST['Reset']))
{
	...
	unset($_SESSION['review_topic_id_session']);
	$_SESSION['review_topic_id_session']="";
...
if(isset($status) && !empty($status))
{
	...
	$db->query($sqlquery);
	header("Location:questions.php?msg=$update_ok_msg&case=1");
	exit;
}
?>
<html>
              ...
              <td><!-- End page header -->
                ...
                <div class="BodyContainer">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td class="heading1">Question Listing</td>
                      </tr>
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Question Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                    ...
                                    style="border:1px solid #000000; padding:10px;">
                                        <tbody>
											...
											<tr height="30">
                                                ...
                                                <td align="center">
                                                    <select name="review_topic_id" id="review_topic_id" class="Field300">
                                                    <option value="">--Please Select Review topic--</option>	
                                                    <?php															
													$sql_qry="Select cat_id,cat_name from tbl_categories where status='1' and level='5'";
													...
													if($sql_arr)
													{
														foreach($sql_arr as $val)
														{
															...
															$cat_name = stripcslashes(html_entity_decode($val['cat_name']));	
																if($_SESSION['review_topic_id_session']==$cat_id)
																{
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <a href="questions.php?sortby=statusasc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }else{?>
                                        <a href="questions.php?sortby=statusdesc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }?>
                                        </td>
									  ...
									  <?php
											...
											$targetpage = "questions.php"; //your file name  (the name of this file)
										...
										$question_qry="select * from tbl_questions where 1=1 $session_where $orderby LIMIT $start, $limit";	
									  ...
									  ?>
										...
										if($status==1)
										{
										  ...
										  <?php
											if($status==0)
											{
												echo '<a href="questions.php?status='.base64_encode(1).'&status_id='.base64_encode($question_id).'"><img src="images/disable.gif" border="0" class="Action" title="Activate"></a>'; 
											}
											if($status==1)
											{
												echo '<a href="questions.php?status='.base64_encode(0).'&status_id='.base64_encode($question_id).'"><img src="images/enable.gif" border="0" class="Action" title="Blocked"></a>'; 
											}
										  ?></td>
