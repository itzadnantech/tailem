...
if(!empty($_POST['cat_ids']))
{
 	if($_POST['dropdown']=='Delete') // from button name="delete"
	{
	 	...
	 	for($i=0;$i<$countCheck;$i++)
		{
			...
			$select_img = "select image_name from tbl_categories where cat_id='".$del_id."'";
		...
		{		
			 ...
			 header('Location:'.SERVER_ADMIN_PATH."sub_cat_list.php?msg=$okmsg&case=1");
		}
		else
		{ 
...
else
{
	...
	header('Location:'.SERVER_ADMIN_PATH."sub_cat_list.php?msg=$errormsg&case=2");
}
?>