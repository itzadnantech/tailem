...
if(isset($_POST)) 
{
	...
	$selected_level2_id = trim($_REQUEST['selected_level2_id']);
	...
	?>
        <table class="process_table">
             <tr>
                ...
                <td width="88%">
                    <select name="level3_cat_id" id="level3_cat_id" class="Field300" style="width:251px;" onChange="edit_category_level4_details(this.value)">
