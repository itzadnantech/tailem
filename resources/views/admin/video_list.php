...

{
	...
	if($_REQUEST['video_title']!="")

	{

		 $sess_where .= " and video_title like \"%".trim($_REQUEST['video_title'])."%\" ";

		 $_SESSION['video_title_sess'] = trim($_REQUEST['video_title']);
...

	{
		...
		unset($_SESSION['video_title_sess']);

	}

	if($_REQUEST['video_cat_id']!="")

	{

		 $sess_where .= " and video_cat_id = '".$_REQUEST['video_cat_id']."' ";

		 $_SESSION['video_cat_id_session'] = trim($_REQUEST['video_cat_id']);
...

	{
		...
		unset($_SESSION['video_cat_id_session']);
	...
	$_SESSION['video_code_sess'] = $sess_where;

}

 $session_where = $_SESSION['video_code_sess'];
...

{
	...
	$_SESSION['video_title_sess']="";

	

	unset($_SESSION['video_cat_id_session']);

	$_SESSION['video_cat_id_session']="";
	...
	unset($_SESSION['video_code_sess']);

	$_SESSION['video_code_sess']="";
...
{
	case "title_desc":
		$orderby	= " ORDER BY video_title desc";
	break;
	case "title_asc":
		$orderby	= " ORDER BY video_title asc";
	break;
	
	case "review_topic_desc":
		$orderby	= " ORDER BY video_cat_id desc";
	break;
	case "review_topic_asc":
		$orderby	= " ORDER BY video_cat_id asc";
	break;
...
if(isset($status) && !empty($status))
{
	...
	if($status == 1)
	{
		$sqlquery	=	"update tbl_videos set status='$status' where video_id='$status_id'";
	}
	else
	{
		$sqlquery	=	"update tbl_videos set status='$status' where video_id='$status_id'";
	...
	header("Location:video_list.php?msg=$update_ok_msg&case=1");
	exit;
}
                ...
                <div class="BodyContainer">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        <td class="heading1">Video Listing</td>
                      ...
                      <tr>
                        ...
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Video Listing</a></td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                    ...
                                                    <input name="video_title" id="video_title" type="text" class="Field300" 

                                                    value="<?php echo $_SESSION['video_title_sess']; ?>" />
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                    ...
                                                    <select name="video_cat_id" id="video_cat_id" class="Field300">
...

													{
...

														{
															...
															//include("cat_hierarchy.php");
																...
																if($_SESSION['video_cat_id_session']==$cat_id)
...
<option value="<?php echo $cat_id;?>" <?php echo $selected;?>> <?php echo $cat_name;?></option>
                                    ...
                                    <tbody>
									  ...
									  <tr>
										  ...
										  <td colspan="5" width="105" align="right" valign="middle" id="addsymbol" >
											...
											<a href="<?php echo SERVER_ADMIN_PATH; ?>addedit_video.php"><img src="images/add.png" border="0" title="Add New Product"></a>
                                      ...
                                      <tr>
                                        ...
                                        <a href="video_list.php?sortby=title_asc&page=<?php echo $page;?>" class="link_class">Title</a>

                                        <?php }else{?>

											<a href="video_list.php?sortby=title_desc&page=<?php echo $page;?>" class="link_class">Title</a>
                                        ...
                                        <a href="video_list.php?sortby=statusasc&page=<?php echo $page;?>" class="link_class">Status</a>

                                        <?php }else{?>

                                        <a href="video_list.php?sortby=statusdesc&page=<?php echo $page;?>" class="link_class">Status</a>
									  ...
									  <form action="<?php echo SERVER_ADMIN_PATH;?>process/video_action.php" method="post" id="video_form">
									  ...
									  <?php
											...
											$qry_count_mypro = "SELECT video_id FROM tbl_videos where 1=1 $session_where  $orderby";

											$res_count_mypro = mysqli_query($db->dbh, $qry_count_mypro);

												

											$targetpage = "video_list.php"; //your file name  (the name of this file)
										...
										$cat_list="select * from tbl_videos where 1=1  $session_where $orderby LIMIT $start, $limit";	
...

										{
...

											{
												...
												$video_code    = stripslashes(html_entity_decode($val['video_code']));
												$video_title   = stripslashes(html_entity_decode($val['video_title']));
												$status        = $val['status'];
												$video_cat_id  = $val['video_cat_id'];
												$video_code    = wordwrap($video_code,100," ",true);
												$video_title   = wordwrap($video_title,100," ",true);
												if($c%2==0)
												{
													$bgcolor = "#FEFEE4";
												}
												...
												$subcat_qry  = "select cat_name as review_topic from 
												tbl_categories where cat_id='".$video_cat_id."' ";	
												...
												$sr_no++;
										?>
									  <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $video_id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $video_id;?>')" id="row<?php echo $video_id;?>">
                                       <td nowrap="nowrap" class="SmallFieldLabel" width="30"><?php echo $sr_no;?></td>
                                       <td nowrap="nowrap" class="SmallFieldLabel" width="225"><?php echo $video_title;?></td>
...

										{
										  ...
										  <?php
...

											{
												...
												echo '<a href="video_list.php?status='.base64_encode(1).'&status_id='.base64_encode($video_id).'"><img src="images/disable.gif" border="0" class="Action" title="Activate"></a>'; 
...

											{
												...
												echo '<a href="video_list.php?status='.base64_encode(0).'&status_id='.base64_encode($video_id).'"><img src="images/enable.gif" border="0" class="Action" title="Blocked"></a>'; 
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="video_ids[]" id="video_ids[]" value="<?php echo base64_encode($video_id);?>" style="margin-top:-5px;" />
                                        ...
                                        <a href="addedit_video.php?edit_id=<?php echo base64_encode($video_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>
										...
										if($top_video_module_delete=='Yes')
                                        ...
                                        <a href="javascript:;" onClick="delete_video('<?php echo $video_id;?>')"><img src="images/delet.gif" border="0" title="Delete User" class="Action" ></a>
