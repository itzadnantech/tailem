...
{
	$keys  = $_REQUEST['key'];
    $categoryid = base64_decode($keys);
	$key_where  = " and comment_cat_id='".$categoryid."'";
	$pagination = 'report_paging.php';
	$path       = 'category_comments.php?key='.$_REQUEST['key'].'';
	$sort_path  = 'category_comments.php?key='.$_REQUEST['key'].'&';
...
else
{
	...
	$path       = 'category_comments.php';
	$sort_path  = 'category_comments.php?';
	$url_path   = '';
}
...
<html>
<head>
<title>Category Comments Listing</title>
              ...
              <td><!-- End page header -->
                ...
                <div class="BodyContainer">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td class="heading1">Category Comments Listing</td>
                      </tr>
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>&raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>sub_cat_list.php">Sub Category Listing</a>&raquo; <a>Category Comments Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
									  ...
									  <?php
											...
											$targetpage = "category_comments.php"; 
										...
										$comment_qry="select * from tbl_comments where 1=1 $key_where 
                                    ...
                                    <input type="hidden" id="categoryid" name="categoryid" value="<?php echo $key;?>"/>
                                        <?php
										if($top_reviews_module_delete=="Yes")
										{
										?>
