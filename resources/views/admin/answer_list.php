...
if(isset($_POST['filter']))
{
	...
	{
		 $sess_where .= " and answer_details  like \"%".trim($_REQUEST['answer_details'])."%\" ";
	...
	{
		$sess_where .= " and ans_user_id_receive = '".$_REQUEST['answer_user_id']."'";
...
{
	case "user_desc":
		$orderby	= " ORDER BY ans_user_id_receive desc";
	break;
	
	case "user_asc":
		$orderby	= " ORDER BY ans_user_id_receive asc";
	break;
	
	default:
		$orderby = "ORDER BY ans_id desc";
	break;
}
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td>
								<a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>question_list.php"> Question Listing </a>&raquo; <a> Answers Listing </a>
								</td>
                              </tr>
                              
							  <?php
                              $question_qry="SELECT * FROM tbl_questions where question_id='".$questionid."' ";
                              ...
                              <tr>
                                ...
                                <?php
									...
									$question_details   = stripslashes(html_entity_decode($question_arr['question_details']));
									$question_user_id   = $question_arr['question_user_id'];
									$question_cat_id    = $question_arr['question_cat_id'];
									$ques_date_added    = $question_arr['date_added'];
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" align="center" class="report_table">
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                <td class="SmallFieldLabelnew font_bold" align="left" width="150">Quetion</td>
                                                <td align="left"><?php echo $question_details;?> </td>
                                            </tr>
                                            ...
                                            <tr height="30" class="last">
                                                ...
                                                <td align="left"><?php echo date("d M Y",$ques_date_added);?>
                                            </tr>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
									  ...
									  <?php
											...
											$qry_count_mypro = "SELECT ans_id FROM tbl_answers where 1=1
											$key_where $session_where $orderby";
											$res_count_mypro = mysqli_query($db->dbh, $qry_count_mypro);
												
											$targetpage = "question_answers.php"; 
										...
										$answers_qry="select * from tbl_answers where 1=1 $key_where 
										$session_where $orderby LIMIT $start, $limit";	
											
										$answers_arr	=	$db->get_results($answers_qry,ARRAY_A);
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="ans_ids[]" id="ans_ids[]" value="<?php echo base64_encode($ans_id);?>" style="margin-top:-5px;" />
                                        &nbsp; &nbsp;
                                        <a href="edit_answer.php?edit_id=<?php echo base64_encode($ans_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>&nbsp; &nbsp;
