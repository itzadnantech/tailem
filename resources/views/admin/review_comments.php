...
{
	$keys  = $_REQUEST['key'];
    $reviewsid = base64_decode($keys);
	$key_where  = " and comment_review_id='".$reviewsid."'";
	$pagination = 'report_paging.php';
	$path       = 'review_comments.php?key='.$_REQUEST['key'].'';
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>&raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>reviews_list.php">Review Listing</a>&raquo; <a>Review Comments Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <a href="review_comments.php?sortby=user_asc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Comment User</a>
                                        <?php }else{?>
                                        <a href="review_comments.php?sortby=user_desc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Comment User</a>
                                        <?php }?>
                                        </td>
									  ...
									  <?php
											...
											$targetpage = "review_comments.php"; 
