...
{
	$keys  = $_REQUEST['key'];
    $questionid = base64_decode($keys);
	$key_where  = " and ques_id='".$questionid."'";
	$pagination = 'report_paging.php';
	$path       = 'question_answers.php?key='.$_REQUEST['key'].'';
}
else
{
	$key_where  = "";
	$pagination = 'paging-playlist.php';
	$path       = 'question_answers.php';
}
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td>
								<a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>questions.php"> Question Listing </a>&raquo; <a> Answers Listing </a>
								</td>
                              </tr>
