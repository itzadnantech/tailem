...
?>
    <a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $prod_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')" style="color:#fff;"><i class="fa fa-heart" style="color:#D73B3B; font-size:24px;"></i></a><a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_5000" data-title="" class="link-disable" style="color:#fff;"> <?php echo $counter_main + 1; ?><?php if (($counter_main + 1) < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } ?></a>
...
?>
    ...
    <a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $prod_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')" style="color:#fff;"><i class="fa fa-heart-o" style="color:#D73B3B; font-size:24px;"></i></a><a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_5000" data-title="" class="link-disable" style="color:#fff;"> <?php echo $counter_main - 1; ?><?php if (($counter_main - 1) < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?></a>
