                    ...
                    <div class="album_cover">
                        ...
                        if ($picture != "") {
                            ...
                            if ($img_api_linka != '') { ?>
                                ...
                                <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><img src="<?php echo $img_api_linka; ?>" border="0" class="img-responsive" style="width:100%; " /></a>
                            <?php } else {
                            ?>
                            ...
                            <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>">
                                <img class="img-responsive" src="<?php echo album_img_api($req_song['song_array']['image4']); ?>" border="0" style="width:100%; " /></a>
                        <?php
                        } elseif ($album_picture != "") {
                        ?>
                            <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><img src="<?php echo SERVER_ROOTPATH; ?>site_upload/album_images/<?php echo 'thumb_' . $album_picture; ?>" border="0" class="img-responsive" style="width:100%; " /></a>
                        <?php
                        } else {
                        ?>
                        ...
                        <div class="bottom_sec" style="padding-bottom:0;">
                            <div class="row">
                                ...
                                <div class="review_screen_txt col-lg-9 col-md-8 col-sm-8 col-xs-8 pad_right">
                                    <label class="mrg_btm font_wgt"><a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>" style="font-size: 16px; color: #fff; font-family: 'Montserrat', sans-serif; font-weight:normal;">
                                ...
                                <span class="usrdetails" style="margin-top:-3px;">
                                    ...
                                    ?>
                                                ...
                                                <?php
                                                    ...
                                                    <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')" class="like"><i class="fa fa-heart heart_size heart_color text_grey"></i></a>
