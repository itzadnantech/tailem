            ...
            <div class="review_item">
                <div class="album_cover">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 txtalnright" style="padding-right:10px;">
                                ...
                                ?><cite class="lightorange" style="background-color:<?php echo $color_pick_all; ?>"><?php if ($all_avg < 10) {
                                        ...
                                        } else { ?> <cite class="lightorange">5.0</cite><?php } ?>
                            </div>
                        </div>
                    </div>
                    ...
                    if ($picture != "") {
                        ...
                        if ($img_api_link != '') {
                    ?>
                            <img src="<?php echo $img_api_link; ?>" border="0" class="img-responsive" style="width:100%; " />
                        <?php
                        } else { ?>
                            <img src="<?php echo SERVER_ROOTPATH; ?>site_upload/song_images/<?php echo 'thumb_' . $picture; ?>" border="0" class="img-responsive" style="width:100%; " />
                        <?php
                        }
                    } elseif ($picture == "") {
                        if ($req_song['song_array']['image4'] != "") {
                        ?>
                            <img class="img-responsive" src="<?php echo $req_song['song_array']['image4']; ?>" border="0" style="width:100%; " />
                        <?php
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4 pad_zero">
                                <span style="float:right; margin-right:8px;" class="like-group">
                                    ...
                                    if ($user_id != "") {
                                        ...
                                        if ($counter == 0) {
                                    ?>
                                            <span id="other_dis_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>','<?php echo $p_fav; ?>')"><i class="fa fa-heart-o" style="font-size:24px; color:#c63937;"></i></a> <?php echo $counter_main; ?><a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#fff;">
                                        ...
                                        <span id="other_dis_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>">
                                            ...
                                            <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#fff;">
                                ...
                                if ($counter == 0) { ?>
                                    ...
                                    if ($review_user_id == $user_id) { ?>
                                        <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>"><a href="javascript:;" title="your own review"><i class="fa fa-heart-o" style="font-size:24px; color:#D73B3B;"></i></a> <?php echo $counter_main;
                                            ...
                                            <a href="<?php echo SERVER_ROOTPATH ?>process/detail_review?user=<?php echo urlencode($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title="" class="like darkgrey_rev">
                                                <?php if ($counter_main < 2) {
                                                    echo " Like";
                                                } else {
                                                    echo " Likes";
                                        ...
                                        <?php
                                            ...
                                            <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')" class="like"><i class="fa fa-heart" style="font-size:24px; color:#D73B3B;"></i></a>
                                                <?php echo $counter_main; ?><a href="<?php echo SERVER_ROOTPATH ?>process/detail_review?user=<?php echo urlencode($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title="" class="like darkgrey_rev">
                                                    <?php if ($counter_main < 2) {
                                                        echo " Like";
                                                    } else {
                                                        echo " Likes";
